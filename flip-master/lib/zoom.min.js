...
(function(f) {
    function q(a, b) { return a[0] == b[0] ? !1 : a.attr("page") ? !0 : a.parent()[0] ? q(a.parent(), b) : !1 }
    ...
    function s(a, b, d) { return p && d ? " translate3d(" + a + "px," + b + "px, 0px) " : " translate(" + a + "px, " + b + "px) " }

    function u(a, b) { return p && b ? " scale3d(" + a + ", " + a + ", 1) " : " scale(" + a + ") " }

    function h(a, b) { return { x: a, y: b } }

    function m(a, b) { return function() { return a.apply(b, arguments) } }
    var p,
        v = { max: 2, flipbook: null, easeFunction: "ease-in-out", duration: 500, when: {} },
        j = {
            init: function(a) {
                var b = this,
                    d = this.data(),
            ...
            _prepareZoom: function() {
                ...
                d.zoomer ||
                    (d.zoomer = f("<div />", { "class": "zoomer", css: { overflow: "hidden", position: "absolute", zIndex: "1000000" } }).mousedown(function() { return false }).appendTo(this));
            ...
            zoomOut: function(a) {
                ...
                if (e.zoomIn) {
                    ...
                    var n = function() {
                        ...
                        } else c.transform("none").turn("zoom", 1).css({ margin: "", top: e.flipPosition.y, left: e.flipPosition.x, position: "relative" });
                        p && c.turn("center");
